...
def generate_narration_audio(elevenlabs_client, narration_text: str, audio_dir: Path) -> Path:
...
def main() -> None:
    ...
    narration_path.write_text(director_plan["narration_text"].strip() + "\n", encoding="utf-8")
